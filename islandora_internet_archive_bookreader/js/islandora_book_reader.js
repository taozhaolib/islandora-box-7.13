...
(function ($) {
  ...
  IslandoraBookReader.prototype.initToolbar = function(mode, ui) {
    ...
    this.buildBookmetadataDiv($('#div-bookmetadata'));
   ...
   * Appends content onto the "Info" module dialog box.
   */
  IslandoraBookReader.prototype.buildBookmetadataDiv = function(jBookmetadataDiv) {
    $(this.settings.info).appendTo(jBookmetadataDiv);
  }
